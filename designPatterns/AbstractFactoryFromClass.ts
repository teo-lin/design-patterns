...
// Concrete Products
class UrgentWorkTask extends UrgentTask {
	do(): void {this.status = 'drafted'}
}
class NormalWorkTask extends NormalTask {
	do(): void {this.status = 'drafted'}
}
class UrgentHomeTask extends UrgentTask {
	do(): void {this.status = 'completed'}
}
class NormalHomeTask extends NormalTask {
	do(): void {this.status = 'completed'}
}
